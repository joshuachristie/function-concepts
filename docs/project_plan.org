...
** Flowchart/workflow for unpacking and disambiguating function sentences
    ...
    3. Detailed unpacking of function (or variant)[fn:6]
       ...
       - 3.8. Can /y/ be identified in the unpacked form? If yes, go to step 4. If no, or if the variant of function being used is directly evaluative (e.g. /dysfunctional/, /non-functional/, /loss of function/, /malfunction/, etc.), go to step 5.
...
[fn:7] Zach, can you write some detailed notes about what sort of examples we get through here? Aside from examples of the two cases, I'm especially interested in any cases that answer no because I'm not sure if I'm always redirecting them correctly.
