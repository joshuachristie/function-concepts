...
** Flowchart/workflow for unpacking and disambiguating function sentences
    ...
    2. Identify the part of speech
        ...
        - 2.2. Manipulate sentence into unpacked form "/x/ functions to do /y/ ...". If /x/ is a sufficiently concrete noun[fn:4] and /y/ (/x's/ effect) can be identified, go to step 4. If /x/ is a concrete noun but /y/ cannot be identified, go to step 5. If /x/ is an abstract noun, go to step 3.3.
    3. Unpack variant of function[fn:5]
    ...
    4. Candidates for biological activity/role/advantage/selected effect
       ...
       - 4.5. Can it be unpacked into the following form: /x/ functions to do /y/, where /x/ is a component (or subcomponent) of a Darwinian individual /i/"? If yes, classify as *function as biological activity* and EXIT; if no, classify as *incompletely specified* and EXIT.
