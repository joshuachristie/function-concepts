...
We'll interpret linking verbs (for subject complements) as anything that indicates essence/identity of the subject (e.g. for "the gene has a function", the verb "has" is perhaps not a typical linking verb but clearly "a gene having a function" is part of its essence (as opposed to possession like "a boy having an icecream").
...
For /y/, look to other verbs associated with "function", or the adverb phrase (or prepositional phrase acting as an adverb) that modifies "function" (e.g. "the promotor functions and regulates the gene..." [verb associated with functions, as both functions and regulates describe the subject], "the promotor that functions as a regulator of the gene" [adverb phrase that modifies function], "the promotor that functions to regulate the gene" [prepositional phrase acting as an adverb]---in all these cases, we can identify /y/ as "regulate the gene"). Note that sometimes you won't find anything, e.g. "the promotor functions to regulate" (transitive verb object missing), or "the promotor functions as an important regulatory component" (transitive verb object is abstract), "the promotor functions" (no candidate for /y/)
*** function as predicate (of an action verb)
