...
The general idea is to use syntactic dependencies (starting from function or its derivative) to unpack a sentence such that semantic relations can be cast into a standard form.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{combined_seleff_towork_toworkadv.png}
