...
A study has recently attempted this for biological function in the context of de novo gene emergence \cite{keeling2019} .
...
Our categories are more closely aligned to philosophical categories than those of Keeling et. al. \cite{keeling2019} who intentionally developed more specific categories for de novo gene function.
...
In the first method, three of the authors (JRC, ZW, SG) independently analysed a subset of the sentences using definitions and a simple set of classification guidelines (much like the approach taken in Keeling et. al. \cite{keeling2019}).
...
With this in mind, we take a very general view of Biological Advantage, adopting Wouters's permissive interpretation of biological advantage as improving a biological role's efficiency without requiring that the characterisation be contrastive.
...
To download the software, explore our working-out of the instances from Keeling et. al. \cite{keeling2019}, or to read the handbook detailing the rules governing the natural language analysis, see
\newline
